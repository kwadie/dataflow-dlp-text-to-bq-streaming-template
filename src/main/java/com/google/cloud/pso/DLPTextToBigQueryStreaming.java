...
import com.google.cloud.pso.DLPTextToBigQueryStreaming.TokenizePipelineOptions;
...
public class DLPTextToBigQueryStreaming {
    ...
    public interface TokenizePipelineOptions extends PipelineOptions {
        ...
        @TemplateParameter.Text(
                order = 7,
                description = "Cloud DLP template region",
                helpText =
                        "Cloud DLP region where the template is stored")
        ValueProvider<String> getDlpRegion();

        void setDlpRegion(ValueProvider<String> value);
    }
    ...
    static class DLPTokenizationDoFn extends DoFn<KV<String, Table>, KV<String, Table>> {
        ...
        private ValueProvider<String> dlpRegion;
        ...
        public DLPTokenizationDoFn(
                ...
                ValueProvider<String> dlpRegion
                ) {
                ...
                if (this.deIdentifyTemplateName.get() != null) {
                    this.requestBuilder =
                            DeidentifyContentRequest.newBuilder()
                                    // This is a fix to avoid using DLP "global" region to lookup templates
